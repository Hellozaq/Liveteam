...
<body>
    <h2 style="text-align:center;">Meu Dashboard de Hoje e Últimos 7 dias</h2>

    <!-- 6. Alertas/recomendações -->
    <%
    ...
    <script>
        ...
        caloriasBar.textContent = porcentagemCalorias + "% (" + totalCalorias + " / " + metaCalorias + " kcal)";
